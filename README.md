<div align="center">
  ...
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=4000&pause=1000&color=2F80ED&center=true&vCenter=true&width=500&lines=%EC%9D%B4%EC%83%81%EC%A4%80+%7C+AI+%2F+Backend+Engineer;Building+Cost-Efficient+AI+Pipelines" alt="Typing SVG" />
  </a>
  ...
  <a href="mailto:dltkdwns0730@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=flat-square&logo=gmail&logoColor=white"/></a>
  <a href="https://www.linkedin.com/in/sangjun-lee-3913493a7/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white"/></a>
  <a href="https://github.com/dltkdwns0730"><img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white"/></a>
...
#### 1. Re:View — Multimodal AI 강의 노트 자동 생성

> FastAPI + LangGraph + Gemini Flash | 198 commits | 5인 팀 · AI & Backend Infra

- **ORB + pHash 슬라이드 중복 제거** → VLM API 호출 **60% 절감**
- **MSA + Redis + Kafka 아키텍처 개선 설계** (모놀리스 → 6서비스 분산 전환 명세)
...
#### 2. PAZULE — AI 기반 파주 관광 체험 플랫폼

> Flask + CLIP/BLIP + LangGraph Multi-Agent | 5인 팀 · Backend Lead | 🏆 파주시장상 (29팀 중 2위)

- **BLIP FP16 양자화** → GPU 메모리 **50% 절감**
- **CLIP Scaled Attention** → 추론 속도 **37.5% 향상**
...
| 강점 | 근거 |
|------|------|
| **비용 효율적 엔지니어링** | VLM 60%↓, GPU 50%↓ — 제한된 리소스에서 최대 성능 |
| **데이터 기반 체계적 실험** | 6단계 반복 개선, WandB 130 실험 중앙관리 |
| **End-to-End 서비스 실행력** | 모델 → 아키텍처 설계 → Docker → Cloud 배포 (198 commits) |
...
| 기간 | 기관 | 내용 |
|------|------|------|
| 2025.09 – 2026.02 | **네이버 부스트캠프 AI Tech 8기** | Computer Vision Track |
| 2021.03 – 2025.02 | **한림대학교** 소프트웨어학부 빅데이터전공 | GPA 3.59 / 4.50 |

<p>
  <img src="https://img.shields.io/badge/정보처리기사-0052CC?style=flat-square"/>
  <img src="https://img.shields.io/badge/빅데이터분석기사-0052CC?style=flat-square"/>
  <img src="https://img.shields.io/badge/ADsP-0052CC?style=flat-square"/>
  <img src="https://img.shields.io/badge/TOEIC_920-2E8B57?style=flat-square"/>
  <img src="https://img.shields.io/badge/OPIc_IH-2E8B57?style=flat-square"/>
</p>

---

<div align="center">
  <sub>배움 → 적용 → 문제 → 해결, 그 사이클을 반복합니다.</sub>
</div>
